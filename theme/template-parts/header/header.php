<header class="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-[#bae3f8] via-[#F5F5F5] to-[#bae3f8] shadow-sm">
  ...
  <section class="relative w-full overflow-visible lg:pt-[75px] pt-[40px]">
        ...
        <div class="relative w-full lg:block hidden">
          ...
          />
                ...
                <img 
                  ...
                  alt="hop-duo"
                />
                <div class="absolute z-20 left-[24%] 2xl:left-[20.6%] -translate-x-1/2 top-[28.6%] flex flex-col space-y-4 text-[16px]  font-bold">
        ...
        <div class="w-full lg:hidden">
            <div class="relative w-full">
              ...
              <img 
                  ...
                  class="absolute z-20 left-[50.8%] -translate-x-1/2 ip:top-[8.9%] top-[11.5%] w-[50px] h-[11px] animate-pulse-pill-header"
                  alt="hop-duo"
                />
              <img 
                src="<?php echo get_stylesheet_directory_uri().'/assets/images/Group-1.png' ?>" 
                class="absolute z-20 left-[45.8%] -translate-x-1/2 top-[6.4%] ip:top-[1.7%] w-[80px] h-[30px] animate-pulse-pill-header"
                alt="hop-duo"
              />

              <div class="absolute z-20 left-[23.2%] -translate-x-1/2 top-[10.6%] flex flex-col space-y-4 text-[16px] text-[#2E368F] font-bold">
                  <!-- <p> <span class="font-black text-[20px] uppercase">viên kép</span> 02 Men </p>
                  <p class="ml-4"> Bụng <span class="font-black text-[20px] uppercase">viên kép</span> - Ruột <span class="font-black text-[20px] uppercase">Ổn</span> </p> -->
                  <?php render_rocket_block('text-block'); ?>
              </div>
              ...
              <div class="-mt-[150px] pt-[80px] pl-3 pr-3 pb-4 relative
