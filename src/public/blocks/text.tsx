    ...
    <div className="">
      <div className="">
        ...
        <div className=" text-[#2E368F] font-bold lg:ml-4 flex">
                ...
                className=" text-[16px] lg:text-[20px] xl:text-[40px] lg:mt-6 mt-1 lg:ml-1 mr-1">Bụng</span>
          <WaveText delay={60} duration={500}>
            <span className="font-black text-[20px] uppercase">YÊN</span>
                ...
                className="text-[16px] lg:text-[20px] xl:text-[40px] lg:mt-6 mt-1 lg:ml-1 mr-1"> - Ruột</span>
          <WaveText delay={60} duration={500}>
